...
export const fetchAnimeList = async (page = 1, limit = 20, orderBy = 'title', sfw = true, type = "tv"): Promise<AnimeListResponse> => {
  return apiGet('/anime', { page, limit, orderBy, sfw, type })
}
